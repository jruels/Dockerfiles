#!/usr/bin/env groovy
node("docker") {
    docker.withRegistry('https://index.docker.io/v1/', 'aslaen-dockerhub') {
    
        git url: "https://github.com/jruels/Dockerfiles.git", credentialsId: 'jruels-github'
        ...
        stage "build"
        def app = docker.build "Dockerfiles"
...
/*node {
    ...
    docker_creds_id = "aslaen-dockerhub" // name of the Jenkins Credentials ID
